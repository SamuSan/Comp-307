...
//  protected static float[] y = new float[20];
  protected static Float[] x = {-2.0f,-1.75f,-1.5f,-1.25f,-1.00f,-0.75f,-0.5f,-0.25f,0.00f,0.25f,0.5f,0.75f,1.00f,1.25f, 1.5f,1.75f,2.0f,2.25f,2.5f,2.75f};

  protected static float[] y = {37.00f,24.1602f,15.0625f,8.9102f,5.0f,2.7227f,1.5625f,1.0977f,1.00f,1.0352f,1.0625f,1.0352f,1.00f,1.0977f,1.5625f,2.7227f,5.0f,8.9102f,15.0625f,24.1602f};
